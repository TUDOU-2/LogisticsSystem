...
namespace LogisticsSystem.API.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ApiResponse> Add([FromBody] UsersDto model) => await service.AddAsync(model);

        [HttpPut]
        public async Task<ApiResponse> Update([FromBody] UsersDto model) => await service.UpdateAsync(model);
